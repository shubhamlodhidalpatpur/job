            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <a href="{{ route('Addresult') }}" class="btn btn-sm btn-primary">Add  Admit card</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush">
                        ...
                        @foreach($result as $resluts)
                            <tr>
                                    <td>{{$loop->index+1}}</td>
                                    <td>{{$resluts->postjob}}</td>
                                    <td>
                                    <a href="{{$resluts->link}}" title="View" target="_blank">{{$resluts->link}}</a>
                                    </td>
                                    <td><div class="action-link">
                                            <a href="getPostjob/{{$resluts->id}}" title="View"><i class="far fa-eye"></i></a>
                                            <!-- <a href="editPostJob/{{$resluts->id}}" title="Edit"><i class="far fa-edit"></i></a> -->
                                            <a href="deleteResult/{{$resluts->id}}" title="Delete"><i class="far fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach 
