          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <div class="w-full">
              ...
              <label class="block text-sm">
                ...
                />
                <span style="color:blue">@error('full_name'){{$message}}@enderror</span>
              ...
              <label class="block text-sm">
                ...
                <input name="mobile_number" type="number"
                  ...
                  placeholder="Jane Doe"
                />
                <span style="color:blue">@error('mobile_number'){{$message}}@enderror</span>
              ...
              <label class="block text-sm">
                ...
                <input name="date_of_birth"  type="date"
                  ...
                  placeholder="Jane Doe"
                />
                <span style="color:blue">@error('date_of_birth'){{$message}}@enderror</span>
              ...
              <label class="block mt-4 text-sm">
                ...
                <input name="password"
                  ...
                  type="password"
                />
                <span style="color:blue">@error('password'){{$message}}@enderror</span>
