            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Visitor User</h3>
                        </div>
                       
                        <div class="col text-right">
                            <a href="{{ route('addvisitor') }}" class="btn btn-sm btn-primary">Add Visitor User</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr> @foreach($visiter_user as $result)
                                ...
                                <td>
                                    <div class="action-link">
                                        <a href="editvisitoruser/{{$result->id}}" title="Edit"><i class="far fa-edit"></i></a>
                                        <a href="destroyvisitoruser/{{$result->id}}" title="Delete"><i class="far fa-trash-alt"></i></a>
                                    </div>
                             </td>
                            </tr>
                            @endforeach
