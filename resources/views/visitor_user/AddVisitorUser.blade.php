            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0"> Add Visitor User</h3>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                                ...
                                <form action="/addvisitoruser" method="POST">
                                    @csrf
                                    <table class="table align-items-center table-flush">
                                        ...
                                        <tr>
                                            ...
                                            <span style="color:blue">@error('first_name'){{$message}}@enderror</span></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td> <input type="password" name="password" class="form-control">
                                                <span style="color:blue">@error('password'){{$message}}@enderror</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td> <select class="select2 form-control" name="state">
                                                ...
                                                <span style="color:blue">@error('state'){{$message}}@enderror</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td> <input type="date" name="date_of_birth" class="form-control">
                                                <span style="color:blue">@error('date_of_birth'){{$message}}@enderror</span></td>

                                        </tr>
                                        <tr>
                                            <th scope="col">Age</th>
                                            <td> <input type="number" name="age" class="form-control">
                                                <span style="color:blue">@error('age'){{$message}}@enderror</span></td>
                                        ...
                                        <tr>
                                            ...
                                            <td> <select class="select2 form-control" name="category">
                                                ...
                                                <span style="color:blue">@error('category'){{$message}}@enderror</span>
                                            </td>

                                        </tr>
                                        <tr>
                                            <th scope="col">Mobile Number</th>
                                            <td> <input type="text" name="mobile_number" class="form-control">
                                                <span style="color:blue">@error('mobile_number'){{$message}}@enderror</span></td>
