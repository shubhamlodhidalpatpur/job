                    ...
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                <div class="col-8">
                                    <h3 class="mb-0"> Add  Annoucement</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="table-responsive">
                            <form action="StoreAnnouncement" method="POST">
                                @csrf
                                <table class="table align-items-center table-flush">
                                    ...
                                    <tr>
                                        ...
                                        <td> <input type="text" name="title" class="form-control">
                                            <span style="color:blue">@error('title'){{$message}}@enderror</span>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="col">Link</th>
                                        <td> <input type="text" name="link" class="form-control">
                                            <span style="color:blue">@error('link'){{$message}}@enderror</span>
                                        </td>
                                    </tr>
                                    <tr>
