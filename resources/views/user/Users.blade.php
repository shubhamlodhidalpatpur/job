                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <a href="{{ route('Addpost') }}" class="btn btn-sm btn-primary">Add  User</a>
                        </div>
                    </div>
                </div>
                        ...
                        <tbody>    @foreach($users as $user)
                            <tr>
                                    ...
                                    <td><div class="action-link">
                                            <a href="getPostjob/{{$user->id}}" title="View"><i class="far fa-eye"></i></a>
                                            <a href="editPostJob/{{$user->id}}" title="Edit"><i class="far fa-edit"></i></a>
                                            <a href="deleteUser/{{$user->id}}" title="Delete"><i class="far fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
