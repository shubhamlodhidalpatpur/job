                ...
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col text-right">
                            <a href="{{ route('AddNotes') }}" class="btn btn-sm btn-primary">Add  Notes</a>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        @foreach($notes as $note)
                            <tr>
                                    ...
                                    <td>{{$note->class}}</td>
                                    <td>
                                    <a href="{{ $path.$note->file }}" title="View" target="_blank">{{$note->file}}</a>
                                    </td>
                                    <td><div class="action-link">
                                            <a href="getPostjob/{{$note->id}}" title="View"><i class="far fa-eye"></i></a>
                                            <a href="editPostJob/{{$note->id}}" title="Edit"><i class="far fa-edit"></i></a>
                                            <a href="deletenote/{{$note->id}}" title="Delete"><i class="far fa-trash-alt"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                @endforeach
